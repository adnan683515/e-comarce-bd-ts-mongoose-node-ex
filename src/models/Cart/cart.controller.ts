...
export const CartCreateController = async (req: Request<ICart>, res: Response) => {
    try {
...
export const getCartSpecificUser = async (req: Request, res: Response) => {
...
export const payMentCartItemsController = async (req: Request<Ipeymentbody>, res: Response) => {
...
export const DeleteCartItemsController = async (req: Request<DeleteParams>, res: Response) => {
